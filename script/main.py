...
"font: 75 11pt \"MS Shell Dlg 2\";")
    ...
    def main_loop(self):
        if _game.settings['timer']:
            if time() - _game.settings['start_time'] >= 2:
                _game.stop_timer()
...
"font: 75 11pt \"MS Shell Dlg 2\";")
    ...
    def bt_run_press(self):
        if not _game.settings['gameStatus']:
            _game.settings['startStatus'] = True
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.run.setText(_translate("MainWindow", "Запуск сценария / кнопка (online)"))
        self.door.setText(_translate("MainWindow", "Геркона двери (online)"))
        self.book.setText(_translate("MainWindow", "Книги (offline)"))
        self.coin.setText(_translate("MainWindow", "Монетница (offline)"))
        self.declaration.setText(_translate("MainWindow", "Кнопка декларации (offline)"))
        self.brick.setText(_translate("MainWindow", "Кнопка кирпича (offline)"))
        self.hand.setText(_translate("MainWindow", "Сканер руки (offline)"))
        self.cup.setText(_translate("MainWindow", "Кубок (offline)"))
        self.table.setText(_translate("MainWindow", "Ящик стола (offline)"))
        self.president.setText(_translate("MainWindow", "Президенты (offline)"))
        self.ring.setText(_translate("MainWindow", "Перстень (offline)"))
        self.players.setText(_translate("MainWindow", "Список участников (online)"))
